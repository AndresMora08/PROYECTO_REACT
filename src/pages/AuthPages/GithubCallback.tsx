  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        console.log("GitHub Callback - Error param:", errorParam);
        
        if (errorParam) {
          const errorDesc = searchParams.get("error_description") || "GitHub authentication was cancelled";
          setError(errorDesc);
          Swal.fire({
            icon: "error",
        ...
        const user = await securityService.handleGithubCallback(code);
        ...
        const errorMessage = err.response?.data?.message || err.message || "Failed to authenticate with GitHub";
